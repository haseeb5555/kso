            ...
            <div className="mx-20 ">
                ...
                <div>
                    ...
                    {addedJobs.length === 0 ? (
                            ...
                            <div key={index} className="border flex flex-col px-6 py-6 w-[250px] space-x-6 text-black">
                                <div className="flex flex-col">
                                    <h3 className="text-semibold text-[18px]">{job.title}</h3>
                                    <p className="text-sm">
                                    {job.description}
                                    </p>
                                </div>
                                <div className="px-4 py-2 bg-[#D9D9D9] text-black w-[100px] rounded-2xl border">
                                    <button onClick={() => handleViewClick(job.id)}>İşe alındı</button>
                                </div>
