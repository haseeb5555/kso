...
const Footer = () => {
    return (
        <div className="bg-[#0e4194] text-white max-w-[1440px] flex flex-col md:flex-row justify-between items-center mx-auto">
              <div className="flex justify-start items-start gap-40 max-sm:gap-16 mx-8 max-sm:flex-wrap max-sm:justify-center max-sm:items-center">
                  <img src="/images/yellow/2.PNG" alt="1" className="w-40 h-full mt-8" />
                  <div className="w-[300px] flex flex-col mt-8 justify-center items-center ml-16 max-sm:ml-4">
                  ...
                  <img src="/images/yellow/1.PNG" alt="" className="h-60 3- -mt-10" />
            </div>
